...
public class GameMessageReturn extends JFrame{
	String id = GameLogin.userId;
	String nickname = GameMessage.nickname;
	String rereceiver = GameMessageGet.rereceiver;
...
//--------------------------------------라벨----------------------------------------------
		...
		receiver = new JTextField(rereceiver);
